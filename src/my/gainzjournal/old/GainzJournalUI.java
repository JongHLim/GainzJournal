...
public class GainzJournalUI extends JFrame {
	...
	public void initComponents() {
		...
		exerciseField.setBounds(59, 0, 122, 28);
		...
		weightField.setBounds(50, 28, 40, 28);
		...
		setsField.setBounds(125, 28, 30, 28);
		...
		repsField.setBounds(198, 28, 30, 28);
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GainzJournalUI frame = new GainzJournalUI();
